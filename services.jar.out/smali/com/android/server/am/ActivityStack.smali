...
.method final destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)Z
    ...
    const-string v13, "destroyActivityLocked, r="
    ...
    invoke-virtual {p0, v0, v11, v12}, Lcom/android/server/am/ActivityStack;->cleanUpActivityLocked(Lcom/android/server/am/ActivityRecord;ZZ)V
    ...
    iget-object v11, v11, Lcom/android/server/am/ProcessRecord;->activities:Ljava/util/ArrayList;
    ...
    iget-object v11, v11, Lcom/android/server/am/ActivityManagerService;->mHeavyWeightProcess:Lcom/android/server/am/ProcessRecord;
    ...
    iput-object v12, v11, Lcom/android/server/am/ActivityManagerService;->mHeavyWeightProcess:Lcom/android/server/am/ProcessRecord;

    .line 3780
    iget-object v11, p0, Lcom/android/server/am/ActivityStack;->mService:Lcom/android/server/am/ActivityManagerService;

    iget-object v11, v11, Lcom/android/server/am/ActivityManagerService;->mHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v11, v12, v0, v13}, Lcom/android/server/am/ActivityManagerService;->updateLruProcessLocked(Lcom/android/server/am/ProcessRecord;ZZ)V
    ...
    iget v14, v0, Lcom/android/server/am/ActivityRecord;->configChangeFlags:I

    invoke-interface {v11, v12, v13, v14}, Landroid/app/IApplicationThread;->scheduleDestroyActivity(Landroid/os/IBinder;ZI)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-object v11, v0, Lcom/android/server/am/ActivityRecord;->app:Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual {v11, v7, v12, v13}, Landroid/os/Handler;->sendMessageDelayed(Landroid/os/Message;J)Z

    .line 3842
    .end local v7           #msg:Landroid/os/Message;
    .end local v9           #skipDestroy:Z
    :goto_3
    const/4 v11, 0x0

    move-object/from16 v0, p1

    iput v11, v0, Lcom/android/server/am/ActivityRecord;->configChangeFlags:I

    .line 3844
    iget-object v11, p0, Lcom/android/server/am/ActivityStack;->mLRUActivities:Ljava/util/ArrayList;
    ...
    const-string v13, " being finished, but not in LRU list"
    ...
    .line 3796
    .restart local v3       #hadApp:Z
    .restart local v9       #skipDestroy:Z
    :catch_0
    move-exception v2
    ...
    .line 3802
    invoke-direct/range {p0 .. p1}, Lcom/android/server/am/ActivityStack;->removeActivityFromHistoryLocked(Lcom/android/server/am/ActivityRecord;)V
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    const-string v4, "Set app to be mHomeProcess, app="
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;[Landroid/net/Uri;IZZ)I
    ...
    const-string v4, ">> startActivityUncheckedLockedImpl"
