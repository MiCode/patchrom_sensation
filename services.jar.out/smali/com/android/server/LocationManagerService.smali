...
.field private static mForceUpdateGpsLocationProvider:Z

.field private static mPrivacyLock:I
...
.method private _loadProvidersLocked()V
    ...
    invoke-direct {v1, v7, p0}, Lcom/android/server/location/GpsLocationProvider;-><init>(Landroid/content/Context;Landroid/location/ILocationManager;)V

    .line 608
    .local v1, gpsProvider:Lcom/android/server/location/GpsLocationProvider;
    invoke-virtual {v1}, Lcom/android/server/location/GpsLocationProvider;->getGpsStatusProvider()Landroid/location/IGpsStatusProvider;
    ...
    .line 609
    invoke-virtual {v1}, Lcom/android/server/location/GpsLocationProvider;->getNetInitiatedListener()Landroid/location/INetInitiatedListener;
    ...
    .line 615
    .end local v1           #gpsProvider:Lcom/android/server/location/GpsLocationProvider;
    :cond_0
    new-instance v3, Lcom/android/server/location/PassiveProvider;

    invoke-direct {v3, p0}, Lcom/android/server/location/PassiveProvider;-><init>(Landroid/location/ILocationManager;)V

    .line 616
    .local v3, passiveProvider:Lcom/android/server/location/PassiveProvider;
    ...
    invoke-virtual {v3}, Lcom/android/server/location/PassiveProvider;->getName()Ljava/lang/String;
    ...
    .line 620
    sget-boolean v7, Lcom/android/server/LocationManagerService;->CUSTOMIZED_NLP_FEATURE:Z
    ...
    const-string v7, "customized_location_provider"
    ...
    invoke-static {v5, v7, v0}, Landroid/provider/Settings$Secure;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v9, "[CustProvider][LoadProvider] NetworkLocation="
    ...
    .line 662
    .end local v0           #customizedProvider:Ljava/lang/String;
    ...
    invoke-virtual {v4, v7, v12}, Landroid/content/pm/PackageManager;->resolveService(Landroid/content/Intent;I)Landroid/content/pm/ResolveInfo;
    ...
    const-string v8, "_loadProvidersLocked: updateProvidersLocked"
    ...
    .restart local v0       #customizedProvider:Ljava/lang/String;
    ...
    .line 642
    .local v6, strSplits:[Ljava/lang/String;
    if-eqz v6, :cond_3
    ...
    iput-object v7, p0, Lcom/android/server/LocationManagerService;->mNetworkLocationProviderPackageName:Ljava/lang/String;
    ...
    iput-object v7, p0, Lcom/android/server/LocationManagerService;->mGeocodeProviderPackageName:Ljava/lang/String;
...
.method private requestLocationUpdatesLocked(Ljava/lang/String;JFZLcom/android/server/LocationManagerService$Receiver;)V
    ...
    const-string v4, "requestLocationUpdatesLocked: updateProvidersLocked"
...
.method private updateProvidersLocked()V
    ...
    .line 1109
    sput-boolean v12, Lcom/android/server/LocationManagerService;->mForceUpdateGpsLocationProvider:Z
    ...
    .line 1118
    invoke-direct {p0, v6, v12}, Lcom/android/server/LocationManagerService;->updateProviderListenersLocked(Ljava/lang/String;Z)V
