...
.method public onProxyAvailable(Ljava/lang/Object;)V
    ...
    .line 81
    .local v0, proxy:Lcom/broadcom/bt/service/framework/BaseProxy;
    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/broadcom/bt/service/framework/BaseProxy;->requiresAccessProcessing()Z
    ...
    .line 82
    iget-byte v1, p0, Lcom/broadcom/bt/service/framework/BluetoothAccessResponse;->mOpCode:B

    iget-boolean v2, p0, Lcom/broadcom/bt/service/framework/BluetoothAccessResponse;->mAllow:Z

    iget-object v3, p0, Lcom/broadcom/bt/service/framework/BluetoothAccessResponse;->mFileName:Ljava/lang/String;

    invoke-virtual {v0, v1, v2, v3}, Lcom/broadcom/bt/service/framework/BaseProxy;->setAccess(IZLjava/lang/Object;)V

    .line 84
    :cond_0
    iput-byte v4, p0, Lcom/broadcom/bt/service/framework/BluetoothAccessResponse;->mOpCode:B
    ...
    .line 86
    iput-boolean v4, p0, Lcom/broadcom/bt/service/framework/BluetoothAccessResponse;->mAllow:Z

    .line 87
    invoke-virtual {v0}, Lcom/broadcom/bt/service/framework/BaseProxy;->finish()V
