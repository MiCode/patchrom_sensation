...
.method buildDependencyChain(Landroid/content/Context;Landroid/content/pm/PackageManager;I)Z
    ...
    .line 430
    :cond_0
    iput p3, v3, Landroid/os/memory/RunningState$ProcessItem;->mCurSeq:I
...
.method ensureLabel(Landroid/content/pm/PackageManager;)V
    ...
    .prologue
    .line 282
    iget-object v8, p0, Landroid/os/memory/RunningState$ProcessItem;->mLabel:Ljava/lang/String;
    ...
    iput-object v8, p0, Landroid/os/memory/RunningState$ProcessItem;->mDisplayLabel:Ljava/lang/CharSequence;

    .line 290
    iget-object v8, p0, Landroid/os/memory/RunningState$ProcessItem;->mDisplayLabel:Ljava/lang/CharSequence;

    invoke-virtual {v8}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object v8

    iput-object v8, p0, Landroid/os/memory/RunningState$ProcessItem;->mLabel:Ljava/lang/String;

    .line 291
    iput-object v0, p0, Landroid/os/memory/RunningState$ProcessItem;->mPackageInfo:Landroid/content/pm/PackageItemInfo;
    :try_end_0
    ...
    .line 322
    iput-object v5, p0, Landroid/os/memory/RunningState$ProcessItem;->mDisplayLabel:Ljava/lang/CharSequence;
    ...
    iput-object v8, p0, Landroid/os/memory/RunningState$ProcessItem;->mPackageInfo:Landroid/content/pm/PackageItemInfo;
    :try_end_2
    ...
    .line 337
    iget-object v8, p0, Landroid/os/memory/RunningState$ProcessItem;->mPackageInfo:Landroid/content/pm/PackageItemInfo;
...
.method updateService(Landroid/content/Context;Landroid/app/ActivityManager$RunningServiceInfo;)Z
    ...
    iput-object v7, v6, Landroid/os/memory/RunningState$ServiceItem;->mDisplayLabel:Ljava/lang/CharSequence;

    .line 369
    iget-object v7, p0, Landroid/os/memory/RunningState$ProcessItem;->mDisplayLabel:Ljava/lang/CharSequence;
    ...
    :goto_1
    iput-object v7, p0, Landroid/os/memory/RunningState$ProcessItem;->mLabel:Ljava/lang/String;
    ...
    iput-object v7, v6, Landroid/os/memory/RunningState$ServiceItem;->mPackageInfo:Landroid/content/pm/PackageItemInfo;
    ...
    .line 373
    :cond_0
    iget v7, p0, Landroid/os/memory/RunningState$ProcessItem;->mCurSeq:I

    iput v7, v6, Landroid/os/memory/RunningState$ServiceItem;->mCurSeq:I
    ...
    :goto_2
    iget-wide v7, v6, Landroid/os/memory/RunningState$ServiceItem;->mActiveSince:J
    ...
    .line 377
    iput-wide v0, v6, Landroid/os/memory/RunningState$ServiceItem;->mActiveSince:J
    ...
    iput-object v7, v6, Landroid/os/memory/RunningState$ServiceItem;->mDescription:Ljava/lang/String;
...
.method updateSize(Landroid/content/Context;JI)Z
    ...
    iput-wide v1, p0, Landroid/os/memory/RunningState$ProcessItem;->mSize:J

    .line 407
    iget v1, p0, Landroid/os/memory/RunningState$ProcessItem;->mCurSeq:I

    if-ne v1, p4, :cond_0

    .line 408
    iget-wide v1, p0, Landroid/os/memory/RunningState$ProcessItem;->mSize:J
    ...
    iget-object v1, p0, Landroid/os/memory/RunningState$ProcessItem;->mSizeStr:Ljava/lang/String;
    ...
    .line 411
    iput-object v0, p0, Landroid/os/memory/RunningState$ProcessItem;->mSizeStr:Ljava/lang/String;
